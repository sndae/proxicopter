...
public:
  ...
  virtual BOOL     GetColumnsRepresNames(CArray<CString> &a_csRowData)const = 0;
  virtual TCHAR*   GetColumnRepresName(int iColnumb)const = 0;
  virtual int      GetColumnsNumber()const = 0;
  virtual TCHAR*   GetTableRepresName()const = 0;
  virtual TCHAR*   GetDBPath()const = 0;
